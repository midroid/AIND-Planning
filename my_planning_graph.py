...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return set(action_a1.effect_add) & set(action_a2.effect_rem) or set(action_a1.effect_rem) & set(action_a2.effect_add)
        # return False
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return set(action_a1.effect_add) & set(action_a2.precond_neg) or \
            set(action_a1.effect_rem) & set(action_a2.precond_pos) or \
            set(action_a2.effect_add) & set(action_a1.precond_neg) or \
            set(action_a2.effect_rem) & set(action_a1.precond_pos)
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for state_1 in node_a1.parents:
            for state_2 in node_a2.parents:
                if state_1.is_mutex(state_2):
                    return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for a1_node in actions_s1:
            for a2_node in actions_s2:
